...
from .analytics import AnalyticsCommandGroup
from .moderation import ModerationCommandGroup
...
def add_commands(client: discord.Client, server_id: str):
    ...
    AnalyticsCommandGroup(params=params).setup(tree)
    ModerationCommandGroup(params=params).setup(tree)
