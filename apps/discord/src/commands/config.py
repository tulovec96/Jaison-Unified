...
@discord.app_commands.command(
    name="vc_response_latency",
    description="Request responses after this many seconds of a pause",
)
...
@discord.app_commands.command(
    name="vc_idle_interval",
    description="Request responses when nothing is said after this many seconds.",
)
